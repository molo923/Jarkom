...
def protopo() :
	...
	#connect 
	net.addLink(h1,r1, intfName='r1-eth0', params2={'ip' : '192.168.1.1/24'},bw=2,max_queue_size=40)
	net.addLink(h2,r1, intfName='r1-eth1', params2={'ip' : '192.168.2.1/24'},bw=1000,max_queue_size=40)
